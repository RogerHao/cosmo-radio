...
**客户**: 杨炜乐 / 上海噗噗噗教育科技有限公司。R1-R3 已交付（¥26,000 已结清）。R4 原 4+8 批量交付合同在 04/02 取消，04/29 与 Arthur 重启为 ¥5,000 技术验证 + 单套原型；**技术验证 2026-05-22 完成，2026-05-31 客户收到成品交付，2026-06-01 开票收款结项（累计 ¥31,000 全部结清）**。
